...
const transportation = data.reduce(function(obj, item) {
  //console.log(item);
  //console.log(obj);
  // the item is the object of the list 

  //we make an entry for it sens theres no item in the object or we dont know
  if(!obj[item]) {
    obj[item] = 0;
  }
  obj[item]++;
...
//this is a black object and it will return the object you can add to that object 
{});
